...
public record TransformRecipeDisplay(
    ...
    public static final MapCodec<TransformRecipeDisplay> MAP_CODEC = RecordCodecBuilder.mapCodec(builder -> {
        return builder
                .group(SlotDisplay.CODEC.listOf().fieldOf("ingredients").forGetter(TransformRecipeDisplay::ingredients),
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, TransformRecipeDisplay> STREAM_CODEC = StreamCodec
            .composite(
    ...
    public static final RecipeDisplay.Type<TransformRecipeDisplay> TYPE = new RecipeDisplay.Type<>(MAP_CODEC,
            STREAM_CODEC);
