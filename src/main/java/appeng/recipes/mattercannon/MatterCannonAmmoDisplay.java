...
public record MatterCannonAmmoDisplay(SlotDisplay ammo, float weight,
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, MatterCannonAmmoDisplay> STREAM_CODEC = StreamCodec
            .composite(
