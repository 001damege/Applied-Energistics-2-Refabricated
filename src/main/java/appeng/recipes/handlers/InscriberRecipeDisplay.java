...
public record InscriberRecipeDisplay(
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, InscriberRecipeDisplay> STREAM_CODEC = StreamCodec
            .composite(
    ...
    public static final RecipeDisplay.Type<InscriberRecipeDisplay> TYPE = new RecipeDisplay.Type<>(MAP_CODEC,
            STREAM_CODEC);
