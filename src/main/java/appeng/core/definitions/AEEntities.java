...
public final class AEEntities {
    ...
    private static <T extends Entity> EntityType<T> create(String id, String englishName, EntityFactory<T> entityFactory, MobCategory classification, Consumer<Builder<T>> customizer) {
